...
const Dashboard = ({listings}: DashboardProps) => {
    return (
        <div className="flex justify-center gap-4 my-8 flex-col mx-4 lg:flex-row">
            <div className=""><AgencyInfoCard/></div>
            <div className="flex flex-col justify-between gap-4">
                <div className=""><ActiveListingsCard listings={listings}/></div>
                <div className=""><AveragePriceCard listings={listings}/></div>
            </div>
        </div>
    );
};
