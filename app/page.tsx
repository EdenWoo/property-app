    ...
    return (
        <div>
            ...
            <div className="px-24 py-10 text-lg">
                <div>
                    <div className="text-3xl font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-4xl">Property
                        App features:
                    </div>
                    <ul className="list-disc">
                        <li><Link href="/listings" target="_blank" className={'text-blue-700'}>Sandbox</Link>: listing
                            data from
                            Domain.com.au.
                        </li>
                        <li><Link href="/local-listings" target="_blank" className={'text-blue-700'}>Local</Link>:
                            listing data from
                            local json data.
                        </li>
